  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      >
        ...
        <div className="relative w-14 h-14 rounded-full bg-[#0E0E11] border border-[#25D366]/50 group-hover:border-[#25D366] flex items-center justify-center text-[#25D366] shadow-[0_8px_30px_rgba(0,0,0,0.8),0_0_20px_rgba(37,211,102,0.35)] group-hover:shadow-[0_8px_35px_rgba(0,0,0,0.9),0_0_30px_rgba(37,211,102,0.65)] group-hover:scale-105 transition-all duration-300">
          <WhatsAppIcon className="w-7 h-7 text-[#25D366] group-hover:scale-110 transition-transform duration-300" color="#25D366" />
        </div>
