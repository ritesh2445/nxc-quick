...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="w-full py-28 md:py-36 px-6 bg-[#000000] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center space-y-16 relative z-10">
        ...
        <div className="space-y-3 max-w-2xl mx-auto">
          ...
          <h2 className="font-sans font-medium text-3xl md:text-4xl lg:text-5xl text-white tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative items-center">
          {/* Step 01: Tap or Scan */}
          <div className="relative bg-[#060608] border border-white/[0.1] hover:border-white/30 rounded-[14px] p-6 sm:p-7 text-left flex items-center justify-between gap-4 transition-all duration-300 min-h-[230px] shadow-[0_20px_50px_rgba(0,0,0,0.8)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.95)] hover:-translate-y-1 group">
            <div className="space-y-2.5 max-w-[160px] sm:max-w-[180px]">
            ...
            {/* Visual Mini Card */}
            <div className="relative w-28 h-36 rounded-[10px] bg-gradient-to-br from-[#1F1F26] via-[#0B0B0E] to-[#000000] border border-white/25 p-2.5 flex flex-col justify-between shadow-2xl flex-shrink-0">
              ...
              <div className="w-10 h-12 mx-auto flex items-center justify-center opacity-95">
                <PhoenixEmblem />
              </div>

              {/* Bottom QR Pattern */}
              <div className="flex justify-end">
                <div className="w-6 h-6 bg-white/10 rounded-[2px] border border-white/30 p-0.5 flex items-center justify-center">
          ...
          <div className="relative bg-[#060608] border border-white/[0.1] hover:border-white/30 rounded-[14px] p-6 sm:p-7 text-left flex items-center justify-between gap-4 transition-all duration-300 min-h-[230px] shadow-[0_20px_50px_rgba(0,0,0,0.8)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.95)] hover:-translate-y-1 group">
            ...
            {/* Visual Phone Mockup */}
            <div className="relative w-28 h-40 rounded-[14px] bg-[#0E0E12] border border-white/20 p-2 flex flex-col items-center justify-between shadow-2xl flex-shrink-0">
              <div className="w-8 h-1 bg-white/20 rounded-full" />
              
              <div className="flex flex-col items-center text-center space-y-1 my-auto">
                <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-[#3A3A45] to-[#70707C] border border-white/40 shadow-inner flex items-center justify-center text-[10px]">
                  👤
                </div>
                <span className="font-sans font-semibold text-[8px] text-white">Aarav Mehta</span>
                <span className="font-sans text-[6px] text-[#A09E9A]">Founder at NXC Verse</span>
                
                <div className="w-full py-0.5 px-1.5 rounded-[4px] bg-white/10 text-[6px] text-[#F2F0EC] border border-white/10 mt-1">
                  Save Contact
                </div>
              </div>

              {/* Social Icons Bar */}
              <div className="flex items-center gap-1.5 opacity-60 text-[8px]">
                <span>𝕏</span>
                <span>📸</span>
                <span>💼</span>
              </div>
          ...
          <div className="relative bg-[#060608] border border-white/[0.1] hover:border-white/30 rounded-[14px] p-6 sm:p-7 text-left flex items-center justify-between gap-4 transition-all duration-300 min-h-[230px] shadow-[0_20px_50px_rgba(0,0,0,0.8)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.95)] hover:-translate-y-1 group">
            ...
            <div className="relative w-28 rounded-[8px] bg-[#0E0E12] border border-white/15 p-2 flex flex-col gap-1.5 shadow-2xl flex-shrink-0">
              <div className="px-2 py-1 rounded-[4px] bg-[#16161C] border border-white/10 flex items-center gap-1.5 text-[7px] text-white">
                <User className="w-2.5 h-2.5 text-[#E2E0DC]" /> Save Contact
              </div>
              <div className="px-2 py-1 rounded-[4px] bg-[#16161C] border border-white/10 flex items-center gap-1.5 text-[7px] text-[#A09E9A]">
