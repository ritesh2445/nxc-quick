    ...
    <div className="space-y-6 text-left">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="bg-[#060608] border border-white/[0.08] rounded-[16px] p-4 sm:p-5 space-y-1 shadow-[0_15px_40px_rgba(0,0,0,0.8)]">
          ...
          <p className="font-sans text-[11px] text-[#70707C]">Direct profile downloads</p>
        </div>
      </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-sans text-xs text-[#8E8E98] flex items-center gap-1">
                            <span>{c.designation || "Executive"}</span>
                            {c.company && (
                              <>
                                <span>·</span>
          ...
          <div className="space-y-4 text-left text-xs">
            <div className="space-y-2.5 bg-[#0A0A0E] border border-white/[0.08] rounded-[14px] p-4">
              ...
              {selectedContact.email && (
                <div className="flex items-center justify-between">
                  <span className="text-[#8E8E98] font-mono text-[11px]">Email:</span>
                  <a href={`mailto:${selectedContact.email}`} className="text-white hover:underline truncate max-w-[200px]">
                    {selectedContact.email}
                  </a>
                </div>
              )}
              <div className="flex items-center justify-between">
                <span className="text-[#8E8E98] font-mono text-[11px]">Source:</span>
