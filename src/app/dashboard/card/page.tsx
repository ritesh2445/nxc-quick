  ...
  return (
    <div className="space-y-8 text-left max-w-5xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-6 bg-[#06060A]/80 border border-white/[0.08] rounded-2xl p-6 sm:p-7 space-y-6 flex flex-col items-center shadow-2xl backdrop-blur-xl">
          ...
          <div className="w-full aspect-[4/3] max-w-[340px] flex items-center justify-center">
          ...
          <div className="w-full pt-4 border-t border-white/[0.08] space-y-2 text-xs font-sans">
            <div className="flex justify-between py-1.5 border-b border-white/5">
              ...
              <span className="text-white font-medium">High-Gloss Piano Pitch Black Metal</span>
            </div>
            <div className="flex justify-between py-1.5 border-b border-white/5">
              <span className="text-[#8E8E98]">NFC Chipset:</span>
              <span className="text-white font-medium">NTAG216 (888 Bytes High-Speed)</span>
            </div>
            <div className="flex justify-between py-1.5 border-b border-white/5">
            ...
            <div className="flex justify-between py-1.5">
              ...
              <span className="font-mono text-white">https://nxcverse.in/@ritesh</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 space-y-6">
          {/* QR Code Matrix Box */}
          <div className="bg-[#06060A]/80 border border-white/[0.08] rounded-2xl p-6 space-y-4 backdrop-blur-xl shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 pt-2">
              <div className="p-3 bg-white rounded-xl shrink-0 shadow-lg border border-white/20">
                {qrSvg ? (
                  ...
                  <img src={qrSvg} alt="Card QR Code" className="w-36 h-36 object-contain" />
                ) : (
                  <div className="w-36 h-36 flex items-center justify-center text-black font-mono text-xs">
                    Generating...
                  </div>
                )}
              </div>
              ...
              <div className="space-y-3 text-left">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-white/[0.04] border border-white/15 hover:border-[#0099FF]/50 text-xs font-sans text-white hover:bg-white/[0.08] transition-all flex items-center gap-1.5 btn-interactive"
                >
          ...
          <div className="bg-[#06060A]/80 border border-white/[0.08] rounded-2xl p-6 space-y-4 backdrop-blur-xl shadow-xl">
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-sans font-semibold tracking-wider uppercase transition-all flex items-center gap-2 btn-interactive ${
                cardLocked
