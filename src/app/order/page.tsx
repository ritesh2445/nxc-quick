      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        {step === "configure" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-6 sticky top-28 bg-[#040406]/90 border border-white/[0.1] rounded-[20px] p-6 sm:p-8 flex flex-col items-center justify-center min-h-[520px] md:min-h-[620px] shadow-[0_25px_70px_rgba(0,0,0,0.95)] backdrop-blur-xl">
